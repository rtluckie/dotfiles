...
with lib; let
  ...
  allModules = [
    ...
    (loadModule ./tools/telepresence.nix {})
    (loadModule ./tools/iterm2.nix {})
    (loadModule ./tools/jq.nix {})
    (loadModule ./tools/k8s.nix {})
    (loadModule ./tools/misc.nix {})
    (loadModule ./tools/navi.nix {})
    ...
    (loadModule ./tools/skim.nix {})
    (loadModule ./tools/sre.nix {})
    (loadModule ./tools/steampipe.nix {})
    (loadModule ./tools/terraform.nix {})
    (loadModule ./tools/text.nix {})
    (loadModule ./tools/tokei.nix {})
