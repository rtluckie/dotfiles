...
with lib; let
  ...
  allMods =
    ...
    ++ [
      ...
      (loadModule ./applications/editors/nvim {})
      ...
      (loadModule ./tools/misc/killport.nix {})
      (loadModule ./tools/misc/plantuml.nix {})
      (loadModule ./tools/misc/pueue.nix {})
...
in (map (getAttr "file") (filter (getAttr "condition") allMods))
